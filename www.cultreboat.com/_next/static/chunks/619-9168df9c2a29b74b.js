    ...
    2619: (e, t, r) => {
      ...
      function y(e) {
        ...
        let r,
          n,
          a,
          [y, b] = (0, u.useOptimistic)(f.IDLE_LINK_STATUS),
          P = (0, u.useRef)(null),
          {
            href: v,
            as: E,
        ...
        let w = u.default.useContext(i.AppRouterContext),
          M = !1 !== O,
          F =
            !1 !== O
              ? null === (t = O) || "auto" === t
        ...
        let B = L ? n && "object" == typeof n && n.ref : R,
          z = u.default.useCallback(
            (e) => (
              null !== w &&
                (P.current = (0, f.mountLinkInstance)(e, D, w, F, M, b)),
              () => {
                (P.current &&
          ...
          Q = {
            ...
            onMouseEnter(e) {
              (L || "function" != typeof A || A(e),
                ...
                w && M && (0, f.onNavigationIntent)(e.currentTarget, !0 === U));
            },
        ...
        return (
          (0, c.isAbsoluteUrl)(K)
            ? (Q.href = K)
            : (L && !S && ("a" !== n.type || "href" in n.props)) ||
              (Q.href = (0, s.addBasePath)(K)),
          (a = L
            ? u.default.cloneElement(n, Q)
            : (0, o.jsx)("a", { ...k, ...Q, children: r })),
          (0, o.jsx)(m.Provider, { value: y, children: a })
        );
      }
