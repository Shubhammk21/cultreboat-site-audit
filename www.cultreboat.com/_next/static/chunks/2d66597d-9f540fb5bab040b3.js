  ...
  [614],
  {
    3401: (e, t, r) => {
      ...
      var i,
        ...
        l = r(9325),
        d = r(6061);
      ((o.W0.PREFER_ENV = a.Fr.any ? s.Km.WEBGL : s.Km.WEBGL2),
        (o.W0.STRICT_TEXTURE_CACHE = !1));
      var f = [];
      function c(e, t) {
        if (!e) return null;
        var r = "";
      ...
      var m = function () {
          return (m =
            ...
            function (e) {
              for (
                var t, r = arguments, i = 1, n = arguments.length;
                i < n;
                i++
              )
                for (var o in (t = r[i]))
        ...
        g = (function () {
          function e(e, t) {
            (void 0 === e && (e = 0),
              ...
              (this.destroyed = !1),
              (this.internal = !1),
              (this.onResize = new h.b("setRealSize")),
              (this.onUpdate = new h.b("update")),
              (this.onError = new h.b("onError")));
          }
          return (
        ...
        _ = { scaleMode: s.M6.NEAREST, format: s.hR.RGBA, alphaMode: s.Gk.NPM },
        b = (function (e) {
          function t(t, r) {
            ...
            var i = e.call(this) || this,
              ...
              b = r.resourceOptions;
            return (
              !t || t instanceof g || ((t = c(t, b)).internal = !0),
              (i.resolution = _ || o.W0.RESOLUTION),
              (i.width = Math.round((d || 0) * i.resolution) / i.resolution),
              (i.height = Math.round((f || 0) * i.resolution) / i.resolution),
              (i._mipmap = void 0 !== u ? u : o.W0.MIPMAP_TEXTURES),
              (i.anisotropicLevel = void 0 !== h ? h : o.W0.ANISOTROPIC_LEVEL),
              (i._wrapMode = p || o.W0.WRAP_MODE),
              (i._scaleMode = void 0 !== l ? l : o.W0.SCALE_MODE),
              (i.format = v || s.hR.RGBA),
              (i.type = m || s.QE.UNSIGNED_BYTE),
              (i.target = y || s.dW.TEXTURE_2D),
              (i.alphaMode = void 0 !== n ? n : s.Gk.UNPACK),
              (i.uid = (0, a.Ld)()),
              (i.touched = 0),
              (i.isPowerOfTwo = !1),
              i._refreshPOT(),
          ...
          return (
            ...
            (t.prototype._refreshPOT = function () {
              this.isPowerOfTwo =
                (0, a.f3)(this.realWidth) && (0, a.f3)(this.realHeight);
            }),
            ...
            (t.prototype.destroy = function () {
              (this.resource &&
                ...
                (this.resource = null)),
                this.cacheId &&
                  (delete a.Du[this.cacheId],
                  delete a.eb[this.cacheId],
                  (this.cacheId = null)),
                this.dispose(),
            ...
            (t.from = function (e, r, i) {
              void 0 === i && (i = o.W0.STRICT_TEXTURE_CACHE);
              ...
              n
                ...
                : (e._pixiId ||
                    (e._pixiId =
                      ((r && r.pixiIdPrefix) || "pixiid") + "_" + (0, a.Ld)()),
                  (s = e._pixiId));
              var u = a.Du[s];
              if (n && i && !u)
                throw Error(
              ...
              return (
                u || (((u = new t(e, r)).cacheId = s), t.addToCache(u, s)),
                u
              );
            }),
            (t.fromBuffer = function (e, r, i, n) {
              var o = new y((e = e || new Float32Array(r * i * 4)), {
                  width: r,
                  height: i,
                }),
                a = e instanceof Float32Array ? s.QE.FLOAT : s.QE.UNSIGNED_BYTE;
              return new t(
                o,
                Object.assign({}, _, n || { width: r, height: i, type: a }),
              );
            }),
            ...
            (t.removeFromCache = function (e) {
              if ("string" == typeof e) {
                ...
                for (var i = 0; i < e.textureCacheIds.length; ++i)
                  delete a.Du[e.textureCacheIds[i]];
        ...
        E = (function (e) {
          function t(t, r) {
            ...
            return (
              ...
              (o = e.call(this, n, { width: a, height: u }) || this),
          ...
          return (
            ...
            (t.prototype.bind = function (t) {
              (e.prototype.bind.call(this, t),
                (t.target = s.dW.TEXTURE_2D_ARRAY));
            }),
            (t.prototype.upload = function (e, t, r) {
              var i = this.length,
                n = this.itemDirtyIds,
        ...
        T = (function (e) {
          function t(t) {
            ...
            return (
              ((r = e.call(this, i, n) || this).source = t),
              (r.noSubImage = !1),
              r
            );
          }
          return (
            v(t, e),
            (t.crossOrigin = function (e, t, r) {
              void 0 === r && 0 !== t.indexOf("data:")
                ? (e.crossOrigin = (0, a.If)(t))
                : !1 !== r &&
            ...
            (t.prototype.upload = function (e, t, r, i) {
              ...
              return (
                ...
                r.height !== a
                  ...
                  : n.texSubImage2D(n.TEXTURE_2D, 0, 0, 0, t.format, r.type, i),
                !0
              );
            }),
            (t.prototype.update = function () {
        ...
        S = (function (e) {
          function t(r, i) {
            ...
            n = e.call(this, 6, { width: a, height: u }) || this;
            for (var d = 0; d < t.SIDES; d++)
              n.items[d].target = s.dW.TEXTURE_CUBE_MAP_POSITIVE_X + d;
            return (
          ...
          return (
            ...
            (t.prototype.bind = function (t) {
              (e.prototype.bind.call(this, t),
                (t.target = s.dW.TEXTURE_CUBE_MAP));
            }),
            (t.prototype.addBaseTextureAt = function (e, t, r) {
              ...
              if (
                ...
                ((e.target = s.dW.TEXTURE_CUBE_MAP_POSITIVE_X + t),
            ...
            (t.prototype.upload = function (e, r, i) {
              for (var n = this.itemDirtyIds, o = 0; o < t.SIDES; o++) {
                ...
                (n[o] < s.dirtyId || i.dirtyId < r.dirtyId) &&
                  (s.valid && s.resource
                    ? (s.resource.upload(e, s, i), (n[o] = s.dirtyId))
                    : n[o] < -1 &&
                      (e.gl.texImage2D(
                        s.target,
                        0,
        ...
        A = (function (e) {
          function t(t, r) {
            ...
            if (((r = r || {}), !(t instanceof HTMLImageElement))) {
              var n = new Image();
              (T.crossOrigin(n, t, r.crossorigin), (n.src = t), (t = n));
            }
            return (
                ...
                (this._process = fetch(t.src, { mode: i ? "cors" : "no-cors" })
                  ...
                  .then(function (i) {
                    return r(i, 0, 0, t.width, t.height, {
                      premultiplyAlpha:
                        null === e.alphaMode || e.alphaMode === s.Gk.UNPACK
                          ? "premultiply"
                          : "none",
                    });
                  })
        ...
        w = (function (e) {
          function t(t, r) {
            ...
            return (
              (r = r || {}),
              ((i = e.call(this, o.W0.ADAPTER.createCanvas()) || this)._width =
                0),
              (i._height = 0),
              (i.svg = t),
              (i.scale = r.scale || 1),
          ...
          return (
            ...
            (t.prototype._loadSvg = function () {
              var e = this,
                t = new Image();
              (T.crossOrigin(t, this.svg, this._crossorigin),
                (t.src = this.svg),
                ...
                (t.onload = function () {
                  if (e._resolve) {
                    ...
                    ((e._overrideWidth || e._overrideHeight) &&
                      ((n = e._overrideWidth || (e._overrideHeight / i) * r),
                      (o = e._overrideHeight || (e._overrideWidth / r) * i)),
                      (n = Math.round(n)),
                      (o = Math.round(o)));
                    var s = e.source;
                    ((s.width = n),
                      (s.height = o),
                      (s._pixiId = "canvas_" + (0, a.Ld)()),
                      s.getContext("2d").drawImage(t, 0, 0, r, i, 0, 0, n, o),
                      e._resolve(),
                      (e._resolve = null));
                  }
                }));
        ...
        I = (function (e) {
          function t(r, i) {
            ...
            if (((i = i || {}), !(r instanceof HTMLVideoElement))) {
              ...
              (o.setAttribute("preload", "auto"),
                ...
                "string" == typeof r && (r = [r]));
              var s = r[0].src || r[0];
              T.crossOrigin(o, s, i.crossorigin);
            ...
            return (
              ((n = e.call(this, r) || this).noSubImage = !0),
              (n._autoUpdate = !0),
          ...
          return (
            ...
            (t.prototype.update = function (t) {
              if (!this.destroyed) {
                var r = l.Rv.shared.elapsedMS * this.source.playbackRate;
            ...
            (t.prototype._onPlayStart = function () {
              (this.valid || this._onCanPlay(),
                this.autoUpdate &&
                  ...
                  (l.Rv.shared.add(this.update, this),
                  (this._isConnectedToTicker = !0)));
            }),
            (t.prototype._onPlayStop = function () {
              this._isConnectedToTicker &&
                (l.Rv.shared.remove(this.update, this),
        ...
        N = (function () {
          function e(e, t) {
            ((this.width = Math.round(e || 100)),
              ...
              (this.colorTextures = []),
              (this.glFramebuffers = {}),
              (this.disposeRunner = new h.b("disposeFramebuffer")),
              (this.multisample = s.he.NONE));
          }
          return (
            ...
            (e.prototype.addDepthTexture = function (e) {
              return (
                (this.depthTexture =
                  e ||
                  new b(
                    new M(null, { width: this.width, height: this.height }),
                    {
                      scaleMode: s.M6.NEAREST,
                      resolution: 1,
                      width: this.width,
                      height: this.height,
                      mipmap: s.E8.OFF,
                      format: s.hR.DEPTH_COMPONENT,
                      type: s.QE.UNSIGNED_SHORT,
                    },
                  )),
                this.dirtyId++,
                this.dirtyFormat++,
          ...
          function t(t) {
            ...
            if ("number" == typeof t) {
              var i = arguments[0],
                ...
                o = arguments[2],
                a = arguments[3];
              t = { width: i, height: n, scaleMode: o, resolution: a };
            }
            return (
              (t.width = t.width || 100),
              (t.height = t.height || 100),
              (t.multisample =
                void 0 !== t.multisample ? t.multisample : s.he.NONE),
              ((r = e.call(this, null, t) || this).mipmap = s.E8.OFF),
              (r.valid = !0),
              ...
              (r.framebuffer.multisample = t.multisample),
              (r.maskStack = []),
              (r.filterStack = [{}]),
              r
            );
          ...
          return (
            (e.prototype.set = function (e, t, r) {
              ...
              if (r) {
                var o = e.width / 2 / i,
                  ...
                  a = e.x / i + o,
                  u = e.y / n + s;
                ((r = d.ER.add(r, d.ER.NW)),
                  (this.x0 = a + o * d.ER.uX(r)),
                  (this.y0 = u + s * d.ER.uY(r)),
                  (r = d.ER.add(r, 2)),
                  (this.x1 = a + o * d.ER.uX(r)),
                  (this.y1 = u + s * d.ER.uY(r)),
                  (r = d.ER.add(r, 2)),
                  (this.x2 = a + o * d.ER.uX(r)),
                  (this.y2 = u + s * d.ER.uY(r)),
                  (r = d.ER.add(r, 2)),
                  (this.x3 = a + o * d.ER.uX(r)),
                  (this.y3 = u + s * d.ER.uY(r)));
              } else
                ((this.x0 = e.x / i),
                  (this.y0 = e.y / n),
            ...
            (e.prototype.toString = function () {
              return (
                ...
                this.y0 +
                " " +
                ("x1=" + this.x1 + " y1=" + this.y1 + " x2=") +
                this.x2 +
                " " +
                ("y2=" + this.y2 + " x3=" + this.x3) +
                " y3=" +
                this.y3 +
                "]"
              );
      ...
      var L = (function (e) {
          function t(r, i, n, o, s, a) {
            ...
            if (
              ((u.noFrame = !1),
              i || ((u.noFrame = !0), (i = new d.M_(0, 0, 1, 1))),
              r instanceof t && (r = r.baseTexture),
              (u.baseTexture = r),
              (u._frame = i),
              (u.trim = o),
              (u.valid = !1),
            ...
            return (
              (u.defaultAnchor = a ? new d.bR(a.x, a.y) : new d.bR(0, 0)),
              (u._updateID = 0),
              (u.textureCacheIds = []),
              r.valid
                ? u.noFrame
          ...
          return (
            ...
            (t.prototype.destroy = function (e) {
              if (this.baseTexture) {
                if (e) {
                  ...
                  (r && r.url && a.eb[r.url] && t.removeFromCache(r.url),
            ...
            (t.from = function (e, r, i) {
              ...
              if (n) s = e;
                ...
                if (!e.cacheId) {
                  ...
                  ((e.cacheId = u + "-" + (0, a.Ld)()),
                    b.addToCache(e, e.cacheId));
                }
                s = e.cacheId;
              } else {
                if (!e._pixiId) {
                  var u = (r && r.pixiIdPrefix) || "pixiid";
                  e._pixiId = u + "_" + (0, a.Ld)();
                }
                s = e._pixiId;
              }
              var h = a.eb[s];
              ...
              return (
                h || e instanceof b
                  ? !h && e instanceof b && ((h = new t(e)), t.addToCache(h, s))
                  : (r.resolution || (r.resolution = (0, a.v5)(e)),
                    ((h = new t(new b(e, r))).baseTexture.cacheId = s),
                    b.addToCache(h.baseTexture, s),
                    t.addToCache(h, s)),
                h
              );
            }),
            (t.fromURL = function (e, r) {
              var i = Object.assign(
                ...
                n = t.from(e, Object.assign({ resourceOptions: i }, r), !1),
            ...
            (t.fromBuffer = function (e, r, i, n) {
              return new t(b.fromBuffer(e, r, i, n));
            }),
            (t.fromLoader = function (e, r, i, n) {
              var s = new b(
                  e,
                  Object.assign(
                    { scaleMode: o.W0.SCALE_MODE, resolution: (0, a.v5)(r) },
                    n,
                  ),
                ),
                u = s.resource;
              u instanceof A && (u.url = r);
              var h = new t(s);
              return (i || (i = r),
              b.addToCache(h.baseTexture, i),
              t.addToCache(h, i),
              i !== r && (b.addToCache(h.baseTexture, r), t.addToCache(h, r)),
              h.baseTexture.valid)
                ? Promise.resolve(h)
            ...
            (t.removeFromCache = function (e) {
              if ("string" == typeof e) {
                ...
                for (var i = 0; i < e.textureCacheIds.length; ++i)
                  a.eb[e.textureCacheIds[i]] === e &&
                    delete a.eb[e.textureCacheIds[i]];
                return ((e.textureCacheIds.length = 0), e);
              }
              return null;
            }),
            ...
            Object.defineProperty(t, "EMPTY", {
              get: function () {
                return (
                  t._EMPTY ||
                    ((t._EMPTY = new t(new b())),
                    U(t._EMPTY),
                    U(t._EMPTY.baseTexture)),
                  t._EMPTY
                );
              },
              enumerable: !1,
            ...
            Object.defineProperty(t, "WHITE", {
              get: function () {
                if (!t._WHITE) {
                  var e = o.W0.ADAPTER.createCanvas(16, 16),
                    r = e.getContext("2d");
                  ((e.width = 16),
                    (e.height = 16),
                    (r.fillStyle = "white"),
                    r.fillRect(0, 0, 16, 16),
                    (t._WHITE = new t(b.from(e))),
                    U(t._WHITE),
                    U(t._WHITE.baseTexture));
                }
                return t._WHITE;
              },
              enumerable: !1,
        ...
        G = (function () {
          ...
          return (
            (e.prototype.createTexture = function (e, t, r) {
              return (
                void 0 === r && (r = s.he.NONE),
                new D(
                  new O(
                    Object.assign(
            ...
            (e.prototype.getOptimalTexture = function (e, t, r, i) {
              ...
              var n,
                o = this.texturePool[n].pop();
              return (
                o || (o = this.createTexture(e, t, i)),
                (o.filterPoolKey = n),
                o.setResolution(r),
                o
              );
        ...
        H = (function () {
          function e(e, t, r) {
            (void 0 === t && (t = !0),
              ...
              (this.static = t),
              (this.id = V++),
              (this.disposeRunner = new h.b("disposeBuffer")));
          }
          return (
            ...
            Object.defineProperty(e.prototype, "index", {
              get: function () {
                return this.type === s.yw.ELEMENT_ARRAY_BUFFER;
              },
              set: function (e) {
                this.type = e ? s.yw.ELEMENT_ARRAY_BUFFER : s.yw.ARRAY_BUFFER;
              },
              enumerable: !1,
              configurable: !0,
            }),
        ...
        Y = (function () {
          function e(e, t) {
            (void 0 === e && (e = []),
              ...
              (this.disposeRunner = new h.b("disposeGeometry")),
              (this.refCount = 0));
          }
          return (
            (e.prototype.addAttribute = function (e, t, r, i, n, o, s, a) {
              if (
                (void 0 === r && (r = 0),
                void 0 === i && (i = !1),
                void 0 === a && (a = !1),
              ...
              if (u.length > 1) {
                for (var h = 0; h < u.length; h++)
                  this.addAttribute(u[h], t, r, i, n);
                return this;
              }
              var l = this.buffers.indexOf(t);
              return (
                -1 === l &&
                  (this.buffers.push(t), (l = this.buffers.length - 1)),
                (this.attributes[e] = new k(l, r, i, n, o, s, a)),
            ...
            (e.prototype.addIndex = function (e) {
              return (
                e instanceof H ||
                  ...
                  (e = new H(e))),
                (e.type = s.yw.ELEMENT_ARRAY_BUFFER),
                (this.indexBuffer = e),
            ...
            (e.prototype.interleave = function () {
              ...
              for (
                e = 0,
                  i.data = (function (e, t) {
                    for (var r = 0, i = 0, n = {}, o = 0; o < e.length; o++)
                      ((i += t[o]), (r += e[o].length));
                    for (
                      var s = new ArrayBuffer(4 * r), u = null, h = 0, o = 0;
                      o < e.length;
                      o++
                    ) {
                      var l = t[o],
            ...
            (e.prototype.clone = function () {
              for (var t = new e(), r = 0; r < this.buffers.length; r++)
                t.buffers[r] = new H(this.buffers[r].data.slice(0));
              for (var r in this.attributes) {
                var i = this.attributes[r];
                t.attributes[r] = new k(
                  i.buffer,
                  i.size,
                  i.normalized,
                  i.type,
              ...
              return (
                this.indexBuffer &&
                  ...
                  (t.indexBuffer.type = s.yw.ELEMENT_ARRAY_BUFFER)),
                t
              );
            }),
            (e.merge = function (t) {
              for (
                var r, i = new e(), n = [], o = [], u = [], h = 0;
                h < t.length;
                h++
              ) {
                r = t[h];
                for (var l = 0; l < r.buffers.length; l++)
                  ((o[l] = o[l] || 0),
                    (o[l] += r.buffers[l].data.length),
                    (u[l] = 0));
              }
              for (var h = 0; h < r.buffers.length; h++)
                ((n[h] = new W[(0, a.L$)(r.buffers[h].data)](o[h])),
                  (i.buffers[h] = new H(n[h])));
              for (var h = 0; h < t.length; h++) {
                r = t[h];
                for (var l = 0; l < r.buffers.length; l++)
                  (n[l].set(r.buffers[l].data, u[l]),
                    (u[l] += r.buffers[l].data.length));
              }
              if (((i.attributes = r.attributes), r.indexBuffer)) {
                ((i.indexBuffer = i.buffers[r.buffers.indexOf(r.indexBuffer)]),
                  (i.indexBuffer.type = s.yw.ELEMENT_ARRAY_BUFFER));
                for (
                  var d = 0, f = 0, c = 0, p = 0, h = 0;
                  h < r.buffers.length;
                  h++
                )
                ...
                for (var h = 0; h < t.length; h++) {
                  for (var m = t[h].indexBuffer.data, l = 0; l < m.length; l++)
                    i.indexBuffer.data[l + c] += d;
        ...
        Q = (function (e) {
          function t() {
            ...
            return (
              ...
              (t.vertexBuffer = new H(t.vertices)),
              (t.uvBuffer = new H(t.uvs)),
              t
        ...
        Z = (function () {
          function e(e, t, r) {
            ((this.group = !0),
              ...
              e instanceof H
                ? ((this.buffer = e),
                  (this.buffer.type = s.yw.UNIFORM_BUFFER),
                  (this.autoManage = !1),
                  (this.ubo = !0))
                : ((this.uniforms = e),
                  this.ubo &&
                    ((this.buffer = new H(new Float32Array(1))),
                    (this.buffer.type = s.yw.UNIFORM_BUFFER),
                    (this.autoManage = !0))));
          }
          return (
        ...
        $ = (function () {
          function e() {
            ((this.renderTexture = null),
              ...
              (this.resolution = 1),
              (this.multisample = s.he.NONE),
              (this.sourceFrame = new d.M_()),
              (this.destinationFrame = new d.M_()),
              (this.bindingSourceFrame = new d.M_()),
              (this.bindingDestinationFrame = new d.M_()),
              (this.filters = []),
              (this.transform = null));
          }
          return (
        ...
        J = [new d.bR(), new d.bR(), new d.bR(), new d.bR()],
        ee = new d.uq(),
        et = (function () {
          function e(e) {
            ((this.renderer = e),
              (this.defaultFilterStack = [{}]),
              (this.texturePool = new G()),
              this.texturePool.setScreenSize(e.view),
              (this.statePool = []),
              (this.quad = new K()),
              (this.quadUv = new Q()),
              (this.tempRect = new d.M_()),
              (this.activeState = {}),
              (this.globalUniforms = new Z(
                {
                  outputFrame: new d.M_(),
          ...
          return (
            (e.prototype.push = function (e, t) {
              for (
                var r,
                  ...
                  s = this.statePool.pop() || new $(),
                  a = this.renderer.renderTexture,
                  u = t[0].resolution,
                  h = t[0].multisample,
                  l = t[0].padding,
                  d = t[0].autoFit,
                  f = null == (r = t[0].legacy) || r,
                  c = 1;
                c < t.length;
                c++
              ) {
                ...
                ((u = Math.min(u, p.resolution)),
                  (h = Math.min(h, p.multisample)),
                  (l = this.useMaxPadding
                    ? Math.max(l, p.padding)
                    : l + p.padding),
                  (d = d && p.autoFit),
                  (f = f || null == (i = p.legacy) || i));
              }
              (1 === o.length &&
              ...
              (n.projection.transform &&
                this.transformAABB(
                  ee.copyFrom(n.projection.transform).invert(),
                  v,
                ),
                d
                  ? (s.sourceFrame.fit(v),
            ...
            (e.prototype.pop = function () {
              ...
              if (
                ...
                (n[2] = 1 / n[0]),
                (n[3] = 1 / n[1]),
                (o[0] = Math.round(n[0] * t.resolution)),
                (o[1] = Math.round(n[1] * t.resolution)),
                (o[2] = 1 / o[0]),
                (o[3] = 1 / o[1]),
                (a[0] = 0.5 * o[2]),
                (a[1] = 0.5 * o[3]),
                (a[2] = t.sourceFrame.width * n[2] - 0.5 * o[2]),
                (a[3] = t.sourceFrame.height * n[3] - 0.5 * o[3]),
                t.legacy)
              ) {
                var u = i.filterArea;
                ((u[0] = t.destinationFrame.width),
                  (u[1] = t.destinationFrame.height),
                  (u[2] = t.sourceFrame.x),
                  (u[3] = t.sourceFrame.y),
              ...
              if ((this.renderer.framebuffer.blit(), 1 === r.length))
                ...
                var l = t.renderTexture,
                  d = this.getOptimalFilterTexture(
                    l.width,
                    l.height,
                    t.resolution,
                  );
                ...
                for (f = 0; f < r.length - 1; ++f) {
                  (1 === f &&
                    ...
                    r[f].apply(this, l, d, s.fr.CLEAR, t));
                  var c = l;
                  ((l = d), (d = c));
                }
                (r[f].apply(this, l, h.renderTexture, s.fr.BLEND, t),
                  f > 1 &&
                    t.multisample > 1 &&
                    this.returnFilterTexture(t.renderTexture),
              ...
              (n.state.set(e.state),
                ...
                e.legacy
                  ? (this.quadUv.map(t._frame, t.filterFrame),
                    ...
                    n.geometry.draw(s._4.TRIANGLES))
                  : (n.geometry.bind(this.quad),
                    n.geometry.draw(s._4.TRIANGLE_STRIP)));
            }),
            (e.prototype.calculateSpriteMatrix = function (e, t) {
              var r = this.activeState,
                ...
                a = t.worldTransform.copyTo(d.uq.TEMP_MATRIX);
              return (
                a.invert(),
                s.prepend(a),
            ...
            (e.prototype.getOptimalFilterTexture = function (e, t, r, i) {
              return (
                void 0 === r && (r = 1),
                void 0 === i && (i = s.he.NONE),
                this.texturePool.getOptimalTexture(e, t, r, i)
              );
            }),
            (e.prototype.getFilterTexture = function (e, t, r) {
              if ("number" == typeof e) {
        ...
        ei = (function () {
          function e(e) {
            ((this.renderer = e),
              (this.emptyRenderer = new er(e)),
              (this.currentRenderer = this.emptyRenderer));
          }
          return (
            (e.prototype.setObjectRenderer = function (e) {
            ...
            (e.prototype.copyBoundTextures = function (e, t) {
              for (
                var r = this.renderer.texture.boundTextures, i = t - 1;
                i >= 0;
                --i
              )
            ...
            (e.prototype.boundArray = function (e, t, r, i) {
              for (
                var n = e.elements, o = e.ids, s = e.count, a = 0, u = 0;
                u < s;
                u++
              ) {
                var h = n[u],
          ...
          return (
            (e.prototype.contextChange = function () {
              ...
              if (
                ...
                (o.W0.PREFER_ENV === s.Km.WEBGL_LEGACY &&
                  ((t = null), (r = null)),
                  t
            ...
            (e.prototype.bind = function (e, t, r) {
              ...
              if (e) {
                ...
                (this.current !== e &&
                  ...
                  n.mipLevel !== r &&
                    (e.dirtyId++, e.dirtyFormat++, (n.mipLevel = r)),
                  n.dirtyId !== e.dirtyId &&
                    ((n.dirtyId = e.dirtyId),
            ...
            (e.prototype.setViewport = function (e, t, r, i) {
              ...
              ((e = Math.round(e)),
                ...
                (r = Math.round(r)),
                (i = Math.round(i)),
                (n.width !== r || n.height !== i || n.x !== e || n.y !== t) &&
                  ((n.x = e),
                  (n.y = t),
                  (n.width = r),
                  (n.height = i),
            ...
            (e.prototype.clear = function (e, t, r, i, n) {
              void 0 === n && (n = s.wn.COLOR | s.wn.DEPTH);
              var o = this.gl;
              (o.clearColor(e, t, r, i), o.clear(n));
            }),
            (e.prototype.initFramebuffer = function (e) {
              var t = new es(this.gl.createFramebuffer());
              return (
                (t.multisample = this.detectSamples(e.multisample)),
                (e.glFramebuffers[this.CONTEXT_UID] = t),
                ...
                if (a) {
                  if (!e) {
                    ...
                    (a.blitFramebuffer ||
                      ...
                      (e = a.blitFramebuffer).colorTextures[0] !== u &&
                        ((e.colorTextures[0] = u),
                        e.dirtyId++,
                        e.dirtyFormat++),
                  ...
                  (t || (((t = ea).width = i.width), (t.height = i.height)),
                    r || (r = t));
                  var h = t.width === r.width && t.height === r.height;
                  (this.bind(e),
          ...
          return (
            (e.prototype.contextChange = function () {
              ...
              if (
                ...
                (o.W0.PREFER_ENV === s.Km.WEBGL_LEGACY && (r = null),
                  r
                ...
                i
                  ? ((e.vertexAttribDivisor = function (e, t) {
                    ...
                    (e.drawElementsInstanced = function (e, t, r, n, o) {
                      return i.drawElementsInstancedANGLE(e, t, r, n, o);
                    }),
                    (e.drawArraysInstanced = function (e, t, r, n) {
                      return i.drawArraysInstancedANGLE(e, t, r, n);
                    }))
                  : (this.hasInstance = !1);
              }
            ...
            (e.prototype.updateBuffers = function () {
              for (
                var e = this._activeGeometry, t = this.renderer.buffer, r = 0;
                r < e.buffers.length;
                r++
              ) {
                var i = e.buffers[r];
            ...
            (e.prototype.initGeometryVao = function (e, t, r) {
              ...
              for (var p in d)
                (!d[p].size && s.attributeData[p]
                  ? (d[p].size = s.attributeData[p].size)
                  : d[p].size ||
                    console.warn(
                  ...
                  (f[d[p].buffer] += d[p].size * eh[d[p].type]));
              for (var p in d) {
                var v = d[p],
                  m = v.size;
                (void 0 === v.stride &&
                  (f[v.buffer] === m * eh[v.type]
                    ? (v.stride = 0)
                    : (v.stride = f[v.buffer])),
                  void 0 === v.start &&
                    ((v.start = c[v.buffer]), (c[v.buffer] += m * eh[v.type])));
              }
                ...
                if ((e.disposeRunner.remove(this), i)) {
                  if (s)
                    for (var a = 0; a < o.length; a++) {
                      ...
                      u &&
                        (u.refCount--,
                        0 !== u.refCount || t || s.dispose(o[a], t));
                    }
                  if (!t) {
                    for (var h in i)
                      if ("g" === h[0]) {
            ...
            (e.prototype.draw = function (e, t, r, i) {
              ...
              if (o.indexBuffer) {
                ...
                o.instanced
                  ? n.drawArraysInstanced(e, r, t || o.getSize(), i || 1)
                  : n.drawArrays(e, r, t || o.getSize());
              return this;
            }),
        ...
        ed = (function () {
          function e(e) {
            (void 0 === e && (e = null),
              ...
              (this.multisample = o.W0.FILTER_MULTISAMPLE),
              (this.enabled = !0),
              (this.colorMask = 15),
              (this._filters = null),
      ...
      function ep(e) {
        for (var t = Array(e), r = 0; r < t.length; r++) t[r] = !1;
        return t;
      }
      function ev(e, t) {
        switch (e) {
      ...
      function ey(e, t, r) {
        if ("precision" !== e.substring(0, 9)) {
          var i = t;
          return (
            t === s.Pk.HIGH && r !== s.Pk.HIGH && (i = s.Pk.MEDIUM),
            "precision " + i + " float;\n" + e
          );
        }
        return r !== s.Pk.HIGH && "precision highp" === e.substring(0, 15)
      ...
      var eT = [
        ...
        eI = (function () {
          function e(t, r, n) {
            (void 0 === n && (n = "pixi-shader"),
              ...
              "#version" !== this.vertexSrc.substring(0, 8) &&
                ...
                (this.vertexSrc = ey(
                  this.vertexSrc,
                  o.W0.PRECISION_VERTEX,
                  s.Pk.HIGH,
                )),
                (this.fragmentSrc = ey(
                  this.fragmentSrc,
                  o.W0.PRECISION_FRAGMENT,
                  (function () {
                    if (!i) {
                      i = s.Pk.MEDIUM;
                      var e = (function () {
                        if (eg === em || (eg && eg.isContextLost())) {
          ...
          return (
            ...
            (e.from = function (t, r, i) {
              var n = t + r,
                o = a.Jh[n];
              return (o || (a.Jh[n] = o = new e(t, r, i)), o);
            }),
            e
          );
        })(),
          ...
          function e(e, t) {
            ((this.uniformBindCount = 0),
              ...
              t
                ? t instanceof Z
                  ? (this.uniformGroup = t)
                  : (this.uniformGroup = new Z(t))
                : (this.uniformGroup = new Z({})),
              (this.disposeRunner = new h.b("disposeShader")));
          }
          return (
        ...
        eF = (function () {
          ...
          return (
            ...
            Object.defineProperty(e.prototype, "blendMode", {
              ...
              set: function (e) {
                ((this.blend = e !== s.B9.NONE), (this._blendMode = e));
              },
              enumerable: !1,
              configurable: !0,
            }),
        ...
        eM = (function (e) {
          function t(r, i, n) {
            var s = this,
              a = eI.from(r || t.defaultVertexSrc, i || t.defaultFragmentSrc);
            return (
              ((s = e.call(this, a, n) || this).padding = 0),
              (s.resolution = o.W0.FILTER_RESOLUTION),
              (s.multisample = o.W0.FILTER_MULTISAMPLE),
              (s.enabled = !0),
              (s.autoFit = !0),
              (s.state = new eF()),
              s
          ...
          return (
            v(t, e),
            (t.prototype.apply = function (e, t, r, i, n) {
          ...
          return (
            ...
            (e.prototype.update = function (e) {
              ...
              n &&
                ...
                this.mapCoord.append(eN));
              var o = t.baseTexture,
                s = this.uClampFrame,
                a = this.clampMargin / o.resolution,
                u = this.clampOffset;
              return (
                (s[0] = (t._frame.x + a + u) / o.width),
          ...
          function t(t, r, i) {
            ...
            return (
              "string" != typeof t &&
                void 0 === r &&
                void 0 === i &&
                ((o = t), (t = void 0), (r = void 0), (i = void 0)),
              ((n =
                e.call(
                  this,
                  t ||
          ...
          return (
            ...
            (t.prototype.apply = function (e, t, r, i) {
              var n = this._maskSprite,
                o = n._texture;
              o.valid &&
                (o.uvMatrix || (o.uvMatrix = new eO(o, 0)),
                o.uvMatrix.update(),
                (this.uniforms.npmAlpha = +!o.baseTexture.alphaMode),
        ...
        eP = (function () {
          ...
          return (
            ...
            (e.prototype.push = function (e, t) {
              var r = t;
              if (!r.isMaskData) {
                var i = this.maskDataPool.pop() || new ed();
              ...
              if (
                ...
                (r._target = e),
                r.type !== s.vg.SPRITE && this.maskStack.push(r),
                r.enabled)
              )
                switch (r.type) {
                  case s.vg.SCISSOR:
            ...
            (e.prototype.pushSpriteMask = function (e) {
              ...
              !a &&
                ((a = this.alphaMaskPool[this.alphaMaskIndex]) ||
                  (a = this.alphaMaskPool[this.alphaMaskIndex] = [new eB()]));
              var u = this.renderer,
                h = u.renderTexture;
              if (h.current) {
                var l = h.current;
                ((i = e.resolution || l.resolution),
                  (n = null != (t = e.multisample) ? t : l.multisample));
              } else
                ((i = e.resolution || u.resolution),
                  (n = null != (r = e.multisample) ? r : u.multisample));
              ((a[0].resolution = i),
                (a[0].multisample = n),
                (a[0].maskSprite = o));
              var d = s.filterArea;
        ...
        eG = (function (e) {
          function t(t) {
            ...
            return (
              (r.glConst =
                o.W0.ADAPTER.getWebGLRenderingContext().SCISSOR_TEST),
              r
            );
          }
          return (
            ...
            (t.prototype.calcScissorRect = function (e) {
              if (!e._scissorRectLocal) {
                var t,
                  ...
                  n = this.renderer,
                  o = n.renderTexture,
                  s = i.getBounds(!0, null != (t = eD.pop()) ? t : new d.M_());
            ...
            (t.prototype._useCurrent = function () {
              var e,
                t = this.maskStack[this.maskStack.length - 1]._scissorRect;
        ...
        ek = (function (e) {
          function t(t) {
            ...
            return (
              (r.glConst =
                o.W0.ADAPTER.getWebGLRenderingContext().STENCIL_TEST),
              r
            );
          }
          return (
            ...
            (t.prototype.push = function (e) {
              ...
              (0 === i &&
                ...
                e._stencilCounter++);
              var n = e._colorMask;
              (0 !== n && ((e._colorMask = 0), r.colorMask(!1, !1, !1, !1)),
                r.stencilFunc(r.EQUAL, i, 0xffffffff),
            ...
            (t.prototype._useCurrent = function () {
              ...
              (e.stencilFunc(e.EQUAL, this.getStackLength(), 0xffffffff),
        ...
        eV = (function () {
          function e(e) {
            ((this.renderer = e),
              ...
              (this.projectionMatrix = new d.uq()),
              (this.transform = null));
          }
          return (
        ...
        eX = (function () {
          ...
          return (
              ...
              ((this.current = e),
                e
                  ? ((o = (i = e.baseTexture).resolution),
                    t ||
                      ((eH.width = e.frame.width),
                      (eH.height = e.frame.height),
                      (t = eH)),
                    r ||
                      ((ej.x = e.frame.x),
                      (ej.y = e.frame.y),
                  ...
                  : ((o = s.resolution),
                    t ||
                      ((eH.width = s.screen.width),
                      (eH.height = s.screen.height),
                      (t = eH)),
                    r || (((r = eH).width = t.width), (r.height = t.height))));
            ...
            (e.prototype.clear = function (e, t) {
              e = this.current
                ? e || this.current.baseTexture.clearColor
                : e || this.clearColor;
      ...
      var eW = {
          ...
          return (
            ...
            (e.prototype.bind = function (e, t) {
              ...
              return (
                ...
                t ||
                  ((eq.textureCount = 0),
                  (eq.uboCount = 0),
                  this.syncUniformGroup(e.uniformGroup, eq)),
                i
              );
            }),
                ...
                this.cache[t] ||
                  (this.cache[t] = (function (e, t) {
                    ...
                    for (var n in e.uniforms) {
                      var o = t[n];
                      if (!o) {
                        (null == (r = e.uniforms[n]) ? void 0 : r.group) &&
                          (e.uniforms[n].ubo
                            ? i.push(
                      ...
                      for (
                        var s = e.uniforms[n], a = !1, u = 0;
                        u < eT.length;
                        u++
                      )
                        if (eT[u].test(o, s)) {
                          (i.push(eT[u].code(n, s)), (a = !0));
                          break;
                        }
                      if (!a) {
                        var h = (1 !== o.size || o.isArray ? eS : eR)[
                          o.type
            ...
            (e.prototype.syncUniformBufferGroup = function (e, t) {
              ...
              if (!e.static || 0 !== e.dirtyId || !r.uniformGroups[e.id]) {
                ...
                (e.buffer.update(),
                  i(r.uniformData, e.uniforms, this.renderer, eq, e.buffer));
              }
            ...
            (e.prototype.createSyncBufferGroup = function (e, t, r) {
              ...
              if (
                (s ||
                  (s = this._uboCache[o] =
                    (function (e, t) {
                      if (!e.autoManage) return { size: 0, syncFunc: ez };
                      for (
                        var r = (function (e) {
                            for (
                        ...
                        for (
                          ...
                          var f = eT[d];
                          if (f.codeUbo && f.test(a.data, u)) {
                            (o.push(
                              "offset = " + a.offset / 4 + ";",
                              eT[d].codeUbo(a.data.name, u),
                            ),
                              (l = !0));
                            break;
                          }
                        ...
                        if (!l)
                          if (a.data.size > 1) {
                            var c = e_[a.data.type],
                              p = Math.max(eY[a.data.type] / 16, 1),
                              v = c / p,
                              m = (4 - (v % 4)) % 4;
                            o.push(
                              "\n                cv = ud." +
            ...
            (e.prototype.generateProgram = function (e) {
              var t = this.gl,
                r = e.program,
                i = (function (e, t) {
                  var r = ef(e, e.VERTEX_SHADER, t.vertexSrc),
                    i = ef(e, e.FRAGMENT_SHADER, t.fragmentSrc),
                    n = e.createProgram();
                  if (
                    (e.attachShader(n, r),
                    e.attachShader(n, i),
                    ...
                    !e.getProgramParameter(n, e.LINK_STATUS) &&
                      (e.getProgramParameter(n, e.LINK_STATUS) ||
                        (e.getShaderParameter(r, e.COMPILE_STATUS) || ec(e, r),
                        e.getShaderParameter(i, e.COMPILE_STATUS) || ec(e, i),
                        console.error(
                    ...
                    for (var s = 0; s < o.length; s++)
                      ((t.attributeData[o[s]].location = s),
                        e.bindAttribLocation(n, s, o[s]));
                    e.linkProgram(n);
                  }
          ...
          return (
            (e.prototype.contextChange = function (e) {
              ...
              ((this.gl = e),
                (this.blendModes =
                  (void 0 === t && (t = []),
                  (t[s.B9.NORMAL] = [e.ONE, e.ONE_MINUS_SRC_ALPHA]),
                  (t[s.B9.ADD] = [e.ONE, e.ONE]),
                  (t[s.B9.MULTIPLY] = [
                    e.DST_COLOR,
                  ...
                  (t[s.B9.OVERLAY] = [e.ONE, e.ONE_MINUS_SRC_ALPHA]),
                  (t[s.B9.DARKEN] = [e.ONE, e.ONE_MINUS_SRC_ALPHA]),
                  (t[s.B9.LIGHTEN] = [e.ONE, e.ONE_MINUS_SRC_ALPHA]),
                  (t[s.B9.COLOR_DODGE] = [e.ONE, e.ONE_MINUS_SRC_ALPHA]),
                  (t[s.B9.COLOR_BURN] = [e.ONE, e.ONE_MINUS_SRC_ALPHA]),
                  (t[s.B9.HARD_LIGHT] = [e.ONE, e.ONE_MINUS_SRC_ALPHA]),
                  (t[s.B9.SOFT_LIGHT] = [e.ONE, e.ONE_MINUS_SRC_ALPHA]),
                  (t[s.B9.DIFFERENCE] = [e.ONE, e.ONE_MINUS_SRC_ALPHA]),
                  (t[s.B9.EXCLUSION] = [e.ONE, e.ONE_MINUS_SRC_ALPHA]),
                  (t[s.B9.HUE] = [e.ONE, e.ONE_MINUS_SRC_ALPHA]),
                  (t[s.B9.SATURATION] = [e.ONE, e.ONE_MINUS_SRC_ALPHA]),
                  (t[s.B9.COLOR] = [e.ONE, e.ONE_MINUS_SRC_ALPHA]),
                  (t[s.B9.LUMINOSITY] = [e.ONE, e.ONE_MINUS_SRC_ALPHA]),
                  (t[s.B9.NONE] = [0, 0]),
                  (t[s.B9.NORMAL_NPM] = [
                    e.SRC_ALPHA,
                    e.ONE_MINUS_SRC_ALPHA,
                  ...
                  (t[s.B9.ADD_NPM] = [e.SRC_ALPHA, e.ONE, e.ONE, e.ONE]),
                  (t[s.B9.SCREEN_NPM] = [
                    e.SRC_ALPHA,
                    e.ONE_MINUS_SRC_COLOR,
                    e.ONE,
                  ...
                  (t[s.B9.SRC_IN] = [e.DST_ALPHA, e.ZERO]),
                  (t[s.B9.SRC_OUT] = [e.ONE_MINUS_DST_ALPHA, e.ZERO]),
                  (t[s.B9.SRC_ATOP] = [e.DST_ALPHA, e.ONE_MINUS_SRC_ALPHA]),
                  (t[s.B9.DST_OVER] = [e.ONE_MINUS_DST_ALPHA, e.ONE]),
                  (t[s.B9.DST_IN] = [e.ZERO, e.SRC_ALPHA]),
                  (t[s.B9.DST_OUT] = [e.ZERO, e.ONE_MINUS_SRC_ALPHA]),
                  (t[s.B9.DST_ATOP] = [e.ONE_MINUS_DST_ALPHA, e.SRC_ALPHA]),
                  (t[s.B9.XOR] = [
        ...
        eJ = (function () {
          function e(e) {
            ((this.renderer = e),
              (this.count = 0),
              (this.checkCount = 0),
              (this.maxIdle = o.W0.GC_MAX_IDLE),
              (this.checkCountMax = o.W0.GC_MAX_CHECK_COUNT),
              (this.mode = o.W0.GC_MODE));
          }
          return (
            (e.prototype.postrender = function () {
              this.renderer.renderingToScreen &&
                (this.count++,
                this.mode !== s.OS.MANUAL &&
                  (this.checkCount++,
            ...
            (e.prototype.run = function () {
              for (
                ...
                !n.framebuffer &&
                  ...
                  (e.destroyTexture(n, !0), (t[i] = null), (r = !0));
              }
              if (r) {
        ...
        e0 = function (e) {
          ((this.texture = e),
            ...
            (this.mipmap = !1),
            (this.wrapMode = 33071),
            (this.type = s.QE.UNSIGNED_BYTE),
            (this.internalFormat = s.hR.RGBA),
            (this.samplerType = 0));
        },
        e1 = (function () {
          function e(e) {
          ...
          return (
            (e.prototype.contextChange = function () {
              ...
              ((this.CONTEXT_UID = this.renderer.CONTEXT_UID),
                ...
                (this.internalFormats =
                  ...
                  R instanceof globalThis.WebGL2RenderingContext
                    ? (((e = {})[s.QE.UNSIGNED_BYTE] =
                        (((t = {})[s.hR.RGBA] = R.RGBA8),
                        (t[s.hR.RGB] = R.RGB8),
                        (t[s.hR.RG] = R.RG8),
                        (t[s.hR.RED] = R.R8),
                        (t[s.hR.RGBA_INTEGER] = R.RGBA8UI),
                        (t[s.hR.RGB_INTEGER] = R.RGB8UI),
                        (t[s.hR.RG_INTEGER] = R.RG8UI),
                        (t[s.hR.RED_INTEGER] = R.R8UI),
                        (t[s.hR.ALPHA] = R.ALPHA),
                        (t[s.hR.LUMINANCE] = R.LUMINANCE),
                        (t[s.hR.LUMINANCE_ALPHA] = R.LUMINANCE_ALPHA),
                        t)),
                      (e[s.QE.BYTE] =
                        (((r = {})[s.hR.RGBA] = R.RGBA8_SNORM),
                        (r[s.hR.RGB] = R.RGB8_SNORM),
                        (r[s.hR.RG] = R.RG8_SNORM),
                        (r[s.hR.RED] = R.R8_SNORM),
                        (r[s.hR.RGBA_INTEGER] = R.RGBA8I),
                        (r[s.hR.RGB_INTEGER] = R.RGB8I),
                        (r[s.hR.RG_INTEGER] = R.RG8I),
                        (r[s.hR.RED_INTEGER] = R.R8I),
                        r)),
                      (e[s.QE.UNSIGNED_SHORT] =
                        (((i = {})[s.hR.RGBA_INTEGER] = R.RGBA16UI),
                        (i[s.hR.RGB_INTEGER] = R.RGB16UI),
                        (i[s.hR.RG_INTEGER] = R.RG16UI),
                        (i[s.hR.RED_INTEGER] = R.R16UI),
                        (i[s.hR.DEPTH_COMPONENT] = R.DEPTH_COMPONENT16),
                        i)),
                      (e[s.QE.SHORT] =
                        (((n = {})[s.hR.RGBA_INTEGER] = R.RGBA16I),
                        (n[s.hR.RGB_INTEGER] = R.RGB16I),
                        (n[s.hR.RG_INTEGER] = R.RG16I),
                        (n[s.hR.RED_INTEGER] = R.R16I),
                        n)),
                      (e[s.QE.UNSIGNED_INT] =
                        (((o = {})[s.hR.RGBA_INTEGER] = R.RGBA32UI),
                        (o[s.hR.RGB_INTEGER] = R.RGB32UI),
                        (o[s.hR.RG_INTEGER] = R.RG32UI),
                        (o[s.hR.RED_INTEGER] = R.R32UI),
                        (o[s.hR.DEPTH_COMPONENT] = R.DEPTH_COMPONENT24),
                        o)),
                      (e[s.QE.INT] =
                        (((a = {})[s.hR.RGBA_INTEGER] = R.RGBA32I),
                        (a[s.hR.RGB_INTEGER] = R.RGB32I),
                        (a[s.hR.RG_INTEGER] = R.RG32I),
                        (a[s.hR.RED_INTEGER] = R.R32I),
                        a)),
                      (e[s.QE.FLOAT] =
                        (((u = {})[s.hR.RGBA] = R.RGBA32F),
                        (u[s.hR.RGB] = R.RGB32F),
                        (u[s.hR.RG] = R.RG32F),
                        (u[s.hR.RED] = R.R32F),
                        (u[s.hR.DEPTH_COMPONENT] = R.DEPTH_COMPONENT32F),
                        u)),
                      (e[s.QE.HALF_FLOAT] =
                        (((h = {})[s.hR.RGBA] = R.RGBA16F),
                        (h[s.hR.RGB] = R.RGB16F),
                        (h[s.hR.RG] = R.RG16F),
                        (h[s.hR.RED] = R.R16F),
                        h)),
                      (e[s.QE.UNSIGNED_SHORT_5_6_5] =
                        (((l = {})[s.hR.RGB] = R.RGB565), l)),
                      (e[s.QE.UNSIGNED_SHORT_4_4_4_4] =
                        (((d = {})[s.hR.RGBA] = R.RGBA4), d)),
                      (e[s.QE.UNSIGNED_SHORT_5_5_5_1] =
                        (((f = {})[s.hR.RGBA] = R.RGB5_A1), f)),
                      (e[s.QE.UNSIGNED_INT_2_10_10_10_REV] =
                        (((c = {})[s.hR.RGBA] = R.RGB10_A2),
                        (c[s.hR.RGBA_INTEGER] = R.RGB10_A2UI),
                        c)),
                      (e[s.QE.UNSIGNED_INT_10F_11F_11F_REV] =
                        (((p = {})[s.hR.RGB] = R.R11F_G11F_B10F), p)),
                      (e[s.QE.UNSIGNED_INT_5_9_9_9_REV] =
                        (((v = {})[s.hR.RGB] = R.RGB9_E5), v)),
                      (e[s.QE.UNSIGNED_INT_24_8] =
                        (((m = {})[s.hR.DEPTH_STENCIL] = R.DEPTH24_STENCIL8),
                        m)),
                      (e[s.QE.FLOAT_32_UNSIGNED_INT_24_8_REV] =
                        (((g = {})[s.hR.DEPTH_STENCIL] = R.DEPTH32F_STENCIL8),
                        g)),
                      (T = e))
                    : (((y = {})[s.QE.UNSIGNED_BYTE] =
                        (((_ = {})[s.hR.RGBA] = R.RGBA),
                        (_[s.hR.RGB] = R.RGB),
                        (_[s.hR.ALPHA] = R.ALPHA),
                        (_[s.hR.LUMINANCE] = R.LUMINANCE),
                        (_[s.hR.LUMINANCE_ALPHA] = R.LUMINANCE_ALPHA),
                        _)),
                      (y[s.QE.UNSIGNED_SHORT_5_6_5] =
                        (((b = {})[s.hR.RGB] = R.RGB), b)),
                      (y[s.QE.UNSIGNED_SHORT_4_4_4_4] =
                        (((x = {})[s.hR.RGBA] = R.RGBA), x)),
                      (y[s.QE.UNSIGNED_SHORT_5_5_5_1] =
                        (((E = {})[s.hR.RGBA] = R.RGBA), E)),
                      (T = y)),
                  T)));
              var S = R.getParameter(R.MAX_TEXTURE_IMAGE_UNITS);
              this.boundTextures.length = S;
              for (var A = 0; A < S; A++) this.boundTextures[A] = null;
              this.emptyTextures = {};
              var w = new e0(R.createTexture());
              (R.bindTexture(R.TEXTURE_2D, w.texture),
                ...
                (this.emptyTextures[R.TEXTURE_2D] = w),
                (this.emptyTextures[R.TEXTURE_CUBE_MAP] = new e0(
                  R.createTexture(),
                )),
                R.bindTexture(
                  R.TEXTURE_CUBE_MAP,
            ...
            (e.prototype.bind = function (e, t) {
              ...
              var r = this.gl;
              if (
                (e = null == e ? void 0 : e.castToBaseTexture()) &&
                e.valid &&
                !e.parentTextureArray
              ) {
            ...
            (e.prototype.ensureSamplerType = function (e) {
              ...
              if (r)
                for (var n = e - 1; n >= 0; --n) {
                  var o = t[n];
                  o &&
                    o._glTextures[i].samplerType !== s.XZ.FLOAT &&
                    this.renderer.texture.unbind(o);
                }
            }),
            (e.prototype.initTexture = function (e) {
              var t = new e0(this.gl.createTexture());
              return (
                (t.dirtyId = -1),
            ...
            (e.prototype.initTextureType = function (e, t) {
              ...
              ((t.internalFormat =
                null !=
                (i =
                  null == (r = this.internalFormats[e.type])
                    ? void 0
                    : r[e.format])
                  ? i
                  : e.format),
                2 === this.webGLVersion && e.type === s.QE.HALF_FLOAT
            ...
            (e.prototype.updateTexture = function (e) {
              ...
              if (t) {
                ...
                if (
                  ...
                  e.resource && e.resource.upload(r, e, t))
                )
                  t.samplerType !== s.XZ.FLOAT &&
                    (this.hasIntegerTextures = !0);
                else {
                  var i = e.realWidth,
                    n = e.realHeight,
                    o = r.gl;
                  (t.width !== i || t.height !== n || t.dirtyId < 0) &&
                    ((t.width = i),
                    (t.height = n),
                    o.texImage2D(
                      e.target,
            ...
            (e.prototype.destroyTexture = function (e, t) {
              ...
              if (
                ...
                -1 !== i && (0, a.dZ)(this.managedTextures, i, 1);
              }
            }),
            (e.prototype.updateTextureStyle = function (e) {
              var t = e._glTextures[this.CONTEXT_UID];
              t &&
                ((e.mipmap !== s.E8.POW2 && 2 === this.webGLVersion) ||
                e.isPowerOfTwo
                  ? (t.mipmap = e.mipmap >= 1)
                  : (t.mipmap = !1),
                2 === this.webGLVersion || e.isPowerOfTwo
                  ? (t.wrapMode = e.wrapMode)
                  : (t.wrapMode = s.uR.CLAMP),
                (e.resource && e.resource.style(this.renderer, e, t)) ||
                  this.setStyle(e, t),
            ...
            (e.prototype.setStyle = function (e, t) {
              ...
              if (
                ...
                if (
                  ...
                  r.texParameterf(e.target, i.TEXTURE_MAX_ANISOTROPY_EXT, n);
                }
              } else
                r.texParameteri(
                  e.target,
                  r.TEXTURE_MIN_FILTER,
                  e.scaleMode === s.M6.LINEAR ? r.LINEAR : r.NEAREST,
                );
              r.texParameteri(
                e.target,
                r.TEXTURE_MAG_FILTER,
        ...
        e2 = {
          ...
          BatchSystem: ei,
          ContextSystem: eo,
          FramebufferSystem: eu,
          GeometrySystem: el,
          MaskSystem: eP,
          ScissorSystem: eG,
          StencilSystem: ek,
          ProjectionSystem: eV,
          RenderTextureSystem: eX,
          ShaderSystem: eZ,
          StateSystem: e$,
          TextureGCSystem: eJ,
          TextureSystem: e1,
        ...
        e4 = (function (e) {
          function t(t, r) {
            void 0 === t && (t = s.h3.UNKNOWN);
            var i = e.call(this) || this;
            return (
              (i.options = r = Object.assign({}, o.W0.RENDER_OPTIONS, r)),
              (i.type = t),
              (i.screen = new d.M_(0, 0, r.width, r.height)),
              (i.view = r.view || o.W0.ADAPTER.createCanvas()),
              (i.resolution = r.resolution || o.W0.RESOLUTION),
              ...
              void 0 !== r.transparent &&
                ...
                (i.backgroundAlpha = +!r.transparent)),
            ...
            (t.prototype.generateTexture = function (e, t, r, i) {
              (void 0 === t && (t = {}),
                "number" == typeof t &&
                  ...
                  (t = { scaleMode: t, resolution: r, region: i })));
              var n = t.region,
                o = (function (e, t) {
                  var r = {};
                  for (var i in e)
              ...
              (0 === (i = n || e.getLocalBounds(null, !0)).width &&
                (i.width = 1),
                0 === i.height && (i.height = 1));
              var s = D.create(m({ width: i.width, height: i.height }, o));
              return (
                (e3.tx = -i.x),
                (e3.ty = -i.y),
                this.render(e, {
            ...
            Object.defineProperty(t.prototype, "backgroundColor", {
              ...
              set: function (e) {
                ((this._backgroundColor = e),
                  (this._backgroundColorString = (0, a.PF)(e)),
                  (0, a.xp)(e, this._backgroundColorRgba));
              },
              enumerable: !1,
              configurable: !0,
            }),
          ...
          return (
            ...
            (e.prototype.bindBufferBase = function (e, t) {
              ...
              if (this.boundBufferBases[t] !== e) {
                ...
                ((this.boundBufferBases[t] = e),
                  r.bindBufferBase(r.UNIFORM_BUFFER, t, n.buffer));
              }
            }),
            ...
            (e.prototype.createGLBuffer = function (e) {
              var t = this.CONTEXT_UID,
                r = this.gl;
              return (
                (e._glBuffers[t] = new e6(r.createBuffer())),
        ...
        e5 = (function (e) {
          function t(r) {
            var i = e.call(this, s.h3.WEBGL, r) || this;
            return (
              (r = i.options),
              (i.gl = null),
              (i.CONTEXT_UID = 0),
              (i.runners = {
                destroy: new h.b("destroy"),
                contextChange: new h.b("contextChange"),
                reset: new h.b("reset"),
                update: new h.b("update"),
                postrender: new h.b("postrender"),
                prerender: new h.b("prerender"),
                resize: new h.b("resize"),
              }),
              i.runners.contextChange.add(i),
              (i.globalUniforms = new Z({ projectionMatrix: new d.uq() }, !0)),
              i
                .addSystem(eP, "mask")
                .addSystem(eo, "context")
                .addSystem(e$, "state")
                .addSystem(eZ, "shader")
                .addSystem(e1, "texture")
                .addSystem(e8, "buffer")
                .addSystem(el, "geometry")
                .addSystem(eu, "framebuffer")
                .addSystem(eG, "scissor")
                .addSystem(ek, "stencil")
                .addSystem(eV, "projection")
                .addSystem(eJ, "textureGC")
                .addSystem(et, "filter")
                .addSystem(eX, "renderTexture")
                .addSystem(ei, "batch"),
              ...
              (0, a.eE)(2 === i.context.webGLVersion ? "WebGL 2" : "WebGL 1"),
          ...
          return (
            ...
            (t.prototype.contextChange = function () {
              ...
              if (1 === this.context.webGLVersion) {
                ...
                var r = t.getParameter(t.DRAW_FRAMEBUFFER_BINDING);
                (t.bindFramebuffer(t.DRAW_FRAMEBUFFER, null),
                  (e = t.getParameter(t.SAMPLES)),
                  t.bindFramebuffer(t.DRAW_FRAMEBUFFER, r));
              }
              e >= s.he.HIGH
                ? (this.multisample = s.he.HIGH)
                : e >= s.he.MEDIUM
                  ? (this.multisample = s.he.MEDIUM)
                  : e >= s.he.LOW
                    ? (this.multisample = s.he.LOW)
                    : (this.multisample = s.he.NONE);
            }),
            (t.prototype.addSystem = function (e, t) {
              var r = new e(this);
              if (this[t])
                throw Error('Whoops! The name "' + t + '" is already in use');
              for (var i in ((this[t] = r), this.runners))
            ...
            (t.prototype.render = function (e, t) {
              if (
                ...
                if ((r || (this._lastObjectRendered = e), !o)) {
                  var r,
                    i,
                    n,
                    o,
                    s = e.enableTempParent();
            ...
            (t.registerPlugin = function (e, t) {
              ((0, a.t6)(
                ...
                u.X.add({ name: e, type: u.A.RendererPlugin, ref: t }));
            }),
            (t.__plugins = {}),
            t
          );
      ...
      u.X.handleByMap(u.A.RendererPlugin, e5.__plugins);
      var e7 =
          "attribute vec2 aVertexPosition;\nattribute vec2 aTextureCoord;\n\nuniform mat3 projectionMatrix;\n\nvarying vec2 vTextureCoord;\n\nvoid main(void)\n{\n    gl_Position = vec4((projectionMatrix * vec3(aVertexPosition, 1.0)).xy, 0.0, 1.0);\n    vTextureCoord = aTextureCoord;\n}",
        te =
          "attribute vec2 aVertexPosition;\n\nuniform mat3 projectionMatrix;\n\nvarying vec2 vTextureCoord;\n\nuniform vec4 inputSize;\nuniform vec4 outputFrame;\n\nvec4 filterVertexPosition( void )\n{\n    vec2 position = aVertexPosition * max(outputFrame.zw, vec2(0.)) + outputFrame.xy;\n\n    return vec4((projectionMatrix * vec3(position, 1.0)).xy, 0.0, 1.0);\n}\n\nvec2 filterTextureCoord( void )\n{\n    return aVertexPosition * (outputFrame.zw * inputSize.zw);\n}\n\nvoid main(void)\n{\n    gl_Position = filterVertexPosition();\n    vTextureCoord = filterTextureCoord();\n}\n";
      ...
      var tt = function () {
        ...
        tn = (function (e) {
          function t(t) {
            ...
            return (
              ...
              (r.vertexSize = null),
              (r.state = eF.for2d()),
              (r.size = 4 * o.W0.SPRITE_BATCH_SIZE),
              (r._vertexCount = 0),
              (r._indexCount = 0),
              (r._bufferedElements = []),
              (r._bufferedTextures = []),
            ...
            (t.prototype.buildTexturesAndDrawCalls = function () {
              ...
              for (var d = 0; d < this._bufferSize; ++d) {
                ...
                ((e[d] = null),
                  f._batchEnabled !== a &&
                    (h.count >= r &&
                      (n.boundArray(h, o, a, r),
                      this.buildDrawCalls(h, l, d),
                      (l = d),
                      (h = i[++u]),
                      ++a),
                    (f._batchEnabled = a),
            ...
            (t.prototype.buildDrawCalls = function (e, r, i) {
              ...
              for (var p = r; p < i; ++p) {
                var v = n[p],
                  ...
                  g = a.ss[+!!m.alphaMode][v.blendMode];
                ((n[p] = null),
                  r < p &&
                    c.blend !== g &&
                    ((c.size = f - c.start),
                    ...
                    ((c = h[++l]).texArray = e),
                    (c.start = f)),
                  this.packInterleavedGeometry(v, o, s, d, f),
                  (d += (v.vertexData.length / 2) * u),
                  (f += v.indices.length),
                  (c.blend = g));
              }
              (r < i && ((c.size = f - c.start), ++l),
                (this._dcIndex = l),
                (this._aIndex = d),
                (this._iIndex = f));
            }),
            (t.prototype.bindAndClearTexArray = function (e) {
              for (var t = this.renderer.texture, r = 0; r < e.count; r++)
            ...
            (t.prototype.drawBatches = function () {
              for (
                ...
                (s !== h && ((s = h), this.bindAndClearTexArray(h)),
                  ...
                  n.set(this.state),
                  i.drawElements(l, d, i.UNSIGNED_SHORT, 2 * f));
              }
            }),
            ...
            (t.prototype.packInterleavedGeometry = function (e, t, r, i, n) {
              for (
                var o = t.uint32View,
                  ...
                  l = e.indices,
                  d = e.vertexData,
                  f = e._texture.baseTexture._batchLocation,
                  c = Math.min(e.worldAlpha, 1),
                  p =
                    c < 1 && e._texture.baseTexture.alphaMode
                      ? (0, a.rQ)(e._tintRGB, c)
                      : e._tintRGB + ((255 * c) << 24),
                  v = 0;
                v < d.length;
                ...
                ((s[i++] = d[v]),
                  ...
                  (o[i++] = p),
                  (s[i++] = f));
              for (var v = 0; v < l.length; v++) r[n++] = u + l[v];
            }),
            (t._drawCallPool = []),
            (t._textureArrayPool = []),
            t
          ...
          return (
            (e.prototype.generateShader = function (e) {
              if (!this.programCache[e]) {
                ...
                this.defaultGroupCache[e] = Z.from({ uSamplers: t }, !0);
                var i = this.fragTemplate;
                ((i = (i = i.replace(/%count%/gi, "" + e)).replace(
                  /%forloop%/gi,
                  this.generateSampleSrc(e),
                )),
                  (this.programCache[e] = new eI(this.vertexSrc, i)));
              }
              var n = {
                tint: new Float32Array([1, 1, 1, 1]),
                translationMatrix: new d.uq(),
                default: this.defaultGroupCache[e],
              };
              return new eC(this.programCache[e], n);
            }),
        ...
        ts = (function (e) {
          function t(t) {
            ...
            return (
              (r._buffer = new H(null, t, !1)),
              (r._indexBuffer = new H(null, t, !0)),
              r
                .addAttribute("aVertexPosition", r._buffer, 2, !1, s.QE.FLOAT)
                .addAttribute("aTextureCoord", r._buffer, 2, !1, s.QE.FLOAT)
                .addAttribute("aColor", r._buffer, 4, !0, s.QE.UNSIGNED_BYTE)
                .addAttribute("aTextureId", r._buffer, 1, !0, s.QE.FLOAT)
          ...
          return (
            (e.create = function (e) {
              var t = Object.assign(
                ...
                o = t.geometryClass;
              function s(e) {
                var t = tn.call(this, e) || this;
                return (
                  (t.shaderGenerator = new to(r, i)),
                  (t.geometryClass = o),
                  (t.vertexSize = n),
                  t
                );
      ...
      Object.assign(th, {
        extension: { name: "batch", type: u.A.RendererPlugin },
      });
      var tl = {},
        td = function (e) {
          Object.defineProperty(tl, e, {
            get: function () {
              return (
                (0, a.t6)(
                  "6.0.0",
                  "PIXI.systems." + e + " has moved to PIXI." + e,
                ),
                F[e]
              );
            },
      ...
      for (var tf in F) td(tf);
      var tc = {},
        tp = function (e) {
          Object.defineProperty(tc, e, {
            get: function () {
              return (
                (0, a.t6)(
                  "6.0.0",
                  "PIXI.resources." + e + " has moved to PIXI." + e,
                ),
                e2[e]
              );
            },
