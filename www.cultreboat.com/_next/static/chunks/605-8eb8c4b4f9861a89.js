      ...
      var n,
            ...
            b !== tn &&
              ...
              6 === b.length
                ...
                : ((J = b[6]),
                  ...
                  (d = (O = g(-A, q)) * c),
                  O &&
                    ((S = E * (w = Math.cos(-O)) - B * (M = Math.sin(-O))),
                    (X = P * w - N * M),
                    (k = A * w - q * M),
                    (I = C * M + I * w),
                    (E = S),
                  ...
                  (l = (O = g(P, E)) * c),
                  O &&
                    ((S = E * (w = Math.cos(O)) + P * (M = Math.sin(O))),
                    (X = Y * w + z * M),
                    (P = P * w - E * M),
                    (z = z * w - Y * M),
                    (E = S),
        ...
        td = function (t, e) {
          ...
          ((g = parseFloat(g)),
            ...
            ((E && !~(u + "").indexOf("px")) ||
              (P && !~(c + "").indexOf("px"))) &&
              ((E = U(x, "x", u, "px")), (P = U(x, "y", c, "px"))),
            (_ || b || O || w) &&
              ((E = (0, f.E_)(E + _ - (_ * r + b * s) + O)),
              (P = (0, f.E_)(P + b - (_ * n + b * i) + w))),
            (l || p) &&
              ((a = x.getBBox()),
              (E = (0, f.E_)(E + (l / 100) * a.width)),
              (P = (0, f.E_)(P + (p / 100) * a.height))),
            (a =
              "matrix(" +
              r +
              "," +
                ...
                if (
                  ...
                  if (
                    ...
                    ((this._pt = new f.J7(
                      ...
                      "scaleY",
                      E.scaleY,
                      (_ ? (0, f.B0)(E.scaleY, _ + l) : l) - E.scaleY || 0,
                      x,
                    )),
                      (this._pt.u = 0),
                      Y.push("scaleY", g),
                    ...
                    (C.push(T, 0, z[T]),
                      ...
                      E.svg
                        ...
                        : ((m = parseFloat(o.split(" ")[2]) || 0) !==
                            E.zOrigin && Z(this, E, "zOrigin", E.zOrigin, m),
                    ...
                    tm(this, E, g, p, _ ? (0, f.B0)(p, _ + o) : o);
                    continue;
                  } else if ("smoothOrigin" === g) {
                    Z(this, E, "smooth", E.smooth, o);
                    continue;
                  } else if ("force3D" === g) {
                    E[g] = o;
                    continue;
